...
usage() {
    echo "This script builds a CPU or GPU based TensorFlow on an AWS OpenShift cluster for RHEL 7 or RHEL 8. Node Feature Discovery may optionally be used for selecting specific nodes, and CPU Manager may optionally be used as well."
    echo ""
    echo ""
